...
int main()
{
	...
	vals_removed = priqueue_remove(&q, &values[13]);
	printf("Elements removed: %d (expected 1).\n", vals_removed);
	vals_removed = priqueue_remove(&q, &values[14]);
	printf("Elements removed: %d (expected 1).\n", vals_removed);
	vals_removed = priqueue_remove(&q, &values[14]);
	printf("Elements removed: %d (expected 0).\n", vals_removed);
	...
	vals_removed = priqueue_remove(&q, &values[12]);
	printf("Elements removed: %d (expected 2).\n", vals_removed);
	printf("Total elements: %d (expected 2).\n", priqueue_size(&q));
	...
	priqueue_remove_at(&q,3);

	printf("Elements in order queue (expected 10 13 14 30): ");
	for (i = 0; i < priqueue_size(&q); i++)
		printf("%d ", *((int *)priqueue_at(&q, i)) );
	printf("\n");
	...
	printf("Elements in order queue (expected 10 13 14): ");
	for (i = 0; i < priqueue_size(&q); i++)
		printf("%d ", *((int *)priqueue_at(&q, i)) );
	printf("\n");
	...
	printf("Elements in order queue (expected 13 14): ");
	for (i = 0; i < priqueue_size(&q); i++)
		printf("%d ", *((int *)priqueue_at(&q, i)) );
	printf("\n");

	priqueue_remove_at(&q,1);

	printf("Elements in order queue (expected 13): ");
	for (i = 0; i < priqueue_size(&q); i++)
		printf("%d ", *((int *)priqueue_at(&q, i)) );
	printf("\n");
	...
	printf("Elements in order queue (expected 12 12 12 13 13 14): ");
	for (i = 0; i < priqueue_size(&q); i++)
		printf("%d ", *((int *)priqueue_at(&q, i)) );
	printf("\n");
